...
此資料夾收錄了使用 GitHub Copilot SDK 配合 .NET 的簡短實用食譜。每份食譜都簡潔、可複製貼上，並指向更完整的範例與測試。
...
藉由在此資料夾中建立 Markdown 檔案並在上方建立連結來新增食譜。遵循 [CONTRIBUTING.md](../../../CONTRIBUTING.md) 中的儲存庫指引。

## 狀態

這些食譜現已完成並可供使用；隨著新場景的增加，此 Cookbook 將持續演進。
