# Dataverse SDK for Python - 進階功能指南

## 概述
本指南全面介紹了 Dataverse SDK 的進階功能，包括枚舉、複雜篩選、SQL 查詢、Metadata 作業和生產模式。內容基於 Microsoft 官方逐步解說範例。
...
## 參考
- [官方逐步解說範例](https://github.com/microsoft/PowerPlatform-DataverseClient-Python/blob/main/examples/advanced/walkthrough.py)
- [OData 篩選語法](https://learn.microsoft.com/en-us/power-apps/developer/data-platform/webapi/query-data-web-api)
- [資料表/資料行 Metadata](https://learn.microsoft.com/en-us/power-apps/developer/data-platform/webapi/create-update-entity-definitions-using-web-api)
