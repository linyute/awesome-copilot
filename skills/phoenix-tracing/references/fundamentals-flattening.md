...
OpenInference 將巢狀資料結構扁平化為點分標記法 (dot-notation) 的屬性，以實現資料庫相容性、OpenTelemetry 相容性以及簡單的查詢。
...
// 原始資料
{
  ...
  llm: {
    ...
    input_messages: [{ role: "user", content: "講個笑話" }],
    output_messages: [{ role: "assistant", content: "為什麼雞要過馬路？" }],
...
// 扁平化後（儲存在 Phoenix spans.attributes JSONB 中）
{
  ...
  "llm.input_messages.0.message.content": "講個笑話",
  "llm.output_messages.0.message.role": "assistant",
  "llm.output_messages.0.message.content": "為什麼雞要過馬路？",
