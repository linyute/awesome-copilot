# Windows 命令參考 (A-Z) (Windows Commands Reference)

來自 [learn.microsoft.com](https://learn.microsoft.com/en-us/windows-server/administration/windows-commands/windows-commands) 的完整命令參考。
