...
| [gem-team](../plugins/gem-team/README.md) | 用於規格驅動開發與自動化驗證的多代理協調框架。 | 15 items | multi-agent, orchestration, tdd, testing, e2e, devops, security-audit, code-review, prd, mobile |
