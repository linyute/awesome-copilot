...
const sourceContentBaseUrl =
  `https://raw.githubusercontent.com/linyute/awesome-copilot/${SOURCE_CONTENT_BRANCH}`;
const publishedArtifactBaseUrl =
  `https://raw.githubusercontent.com/linyute/awesome-copilot/${PUBLISHED_ARTIFACT_BRANCH}`;
